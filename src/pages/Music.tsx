...
const MUSIC_SECTIONS: LanguageSection[] = [
  {
    ...
    playableCover: '/assets/music/covers/hold_on.jpg',
    ...
    favSongs: [
      {
        ...
        cover: '/assets/music/covers/hold_on.jpg',
      },
      {
        title: 'Night Changes',
        artist: 'One Direction',
        cover: '/assets/music/covers/night_changes.jpg',
      },
      {
        title: 'Hope / Sad! / Moonlight',
        artist: 'XXXTENTACION',
        cover: '/assets/music/covers/sad_moonlight.jpg',
      },
      {
        title: 'Starboy / Blinding Lights',
        artist: 'The Weeknd',
        cover: '/assets/music/covers/starboy.jpg',
      },
      {
        title: 'Attention / We Don’t Talk Anymore',
        artist: 'Charlie Puth',
        cover: '/assets/music/covers/attention.jpg',
      },
    ],
    favArtists: [
      {
        name: 'One Direction',
        badge: 'Favorite Band 🎸',
        img: '/assets/music/artists/one_direction.jpg',
      ...
      },
      {
        ...
        img: '/assets/music/artists/xxxtentacion.jpg',
      ...
      },
      {
        name: 'The Weeknd',
        badge: 'XO Night Owl 🌙',
        img: '/assets/music/artists/the_weeknd.jpg',
      ...
      },
      {
        name: 'Justin Bieber',
        badge: 'Pop Royalty 💛',
        img: '/assets/music/artists/justin_bieber.jpg',
      ...
      },
      {
        name: 'Charlie Puth',
        badge: 'Pitch Perfect 🎹',
        img: '/assets/music/artists/charlie_puth.jpg',
  ...
  },
  {
    ...
    playableCover: '/assets/music/covers/master_blaster.jpg',
    ...
    favSongs: [
      {
        ...
        cover: '/assets/music/covers/master_blaster.jpg',
      },
      {
        title: 'Gaali Vaaluga',
        artist: 'Anirudh (Agnyaathavaasi)',
        cover: '/assets/music/covers/gaali_vaaluga.jpg',
      },
      {
        title: 'Hukum (Tiger Ka Hukum)',
        artist: 'Anirudh (Jailer)',
        cover: '/assets/music/covers/hukum.jpg',
      },
      {
        title: 'Badass (Bloody Sweet)',
        artist: 'Anirudh (Leo)',
        cover: '/assets/music/covers/badass.jpg',
      },
    ],
    favArtists: [
      {
        ...
        badge: 'Rockstar Ani ⚡',
        img: '/assets/music/artists/anirudh.jpg',
  ...
  },
  {
    ...
    playableCover: '/assets/music/covers/zaalima.jpg',
    ...
    favSongs: [
      {
        ...
        cover: '/assets/music/covers/zaalima.jpg',
      },
      {
        title: 'Maula Mera',
        artist: 'Roop Kumar Rathod (Anwar)',
        cover: '/assets/music/covers/maula_mera.jpg',
      },
      {
        title: 'Tum Prem Ho',
        artist: 'Mohit Lalwani (RadhaKrishn)',
        cover: '/assets/music/covers/tum_prem_ho.jpg',
      },
      {
        title: 'Channa Mereya',
        artist: 'Arijit Singh (ADHM)',
        cover: '/assets/music/covers/channa_mereya.jpg',
      },
      {
        title: 'Alag Aasmaan / Mishri',
        artist: 'Anuv Jain',
        cover: '/assets/music/covers/anuv_mishri.jpg',
      },
    ],
    favArtists: [
      {
        ...
        img: '/assets/music/artists/arijit_singh.jpg',
      ...
      },
      {
        ...
        img: '/assets/music/artists/anuv_jain.jpg',
  ...
  },
  {
    ...
    playableCover: '/assets/music/covers/nandemonaiya.jpg',
    ...
    favSongs: [
      {
        ...
        cover: '/assets/music/covers/nandemonaiya.jpg',
      },
      {
        title: 'Your Lie in April OST (Hikaru Nara)',
        artist: 'Goose House (四月は君の嘘)',
        cover: '/assets/music/covers/hikaru_nara.jpg',
      },
      {
        title: 'In the Pool',
        artist: 'Rascal Does Not Dream OST',
        cover: '/assets/music/covers/in_the_pool.jpg',
      },
      {
        title: 'Fukashigi no Carte',
        artist: 'Mai Sakurajima (Bunny Girl Senpai ED)',
        cover: '/assets/music/covers/fukashigi_no_carte.jpg',
      },
      {
        title: 'Shinunoga E-Wa',
        artist: 'Fujii Kaze (死ぬのがいいわ)',
        cover: '/assets/music/covers/shinunoga_e_wa.jpg',
      },
    ],
    favArtists: [
      {
        ...
        img: '/assets/music/artists/radwimps.jpg',
      ...
      },
      {
        ...
        img: '/assets/music/artists/fujii_kaze.jpg',
